...
export function SimpleEditor({
  ...
  const editor = useEditor({
    ...
    // 没有外部内容时，回退到官方示例内容。
    content: initialContent ?? demoContent,
  ...
  useEffect(() => {
    ...
    if (
      ...
      lastAppliedContentRef.current.content === initialContent
    ) {
      return
    }
    ...
    lastAppliedContentRef.current = { key: contentKey, content: initialContent }
